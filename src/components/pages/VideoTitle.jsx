...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-screen aspect-video pt-[13%] px-25 absolute text-white bg-gradient-to-r from-black">
      ...
      <div className="mt-5">
        <button className="bg-white text-black px-10 py-3 rounded-md hover:bg-white/90 transition-colors mr-5">
          <span className="flex items-center justify-center gap-4 text-xl">
            <FaPlay /> Play
          </span>
        </button>
